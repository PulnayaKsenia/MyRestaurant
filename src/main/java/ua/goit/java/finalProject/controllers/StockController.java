...
import ua.goit.java.finalProject.services.StockService;
...
public class StockController {
    ...
    public ModelAndView getIngredient(@PathVariable int ingredientId) {
        ...
        Stock ingredient = storageService.getById(ingredientId);
    ...
    @Autowired
    public void setStorageService(StockService storageService) {
