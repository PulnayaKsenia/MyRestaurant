package ua.goit.java.finalProject.controllers;
...
import ua.goit.java.finalProject.services.EmployeeService;
import ua.goit.java.finalProject.services.OrderService;
...
public class EmployeeController {
                                       ...
                                       @RequestParam("employeePosition") String position)
    {
        ModelAndView modelAndView = new ModelAndView();
            ...
            employeeService.addNewEmployee(firstName, position);
                                               ...
                                               @RequestParam("employeePosition") String position)
    {
        ...
        Employee employeeWithNewInformation = employeeService.setInformation(firstName, position);
