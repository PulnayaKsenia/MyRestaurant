...
import ua.goit.java.finalProject.services.DishService;
import ua.goit.java.finalProject.services.IngredientService;
...
public class DishController{
                                   ...
                                   @RequestParam("dishWeight") int weight)
    {
        ...
        dishService.saveNewDish(name, price, weight, selectedIngredients);
